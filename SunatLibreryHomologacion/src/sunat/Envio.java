...
public class Envio {
    ...
    public boolean  enviarResumenDiario()
    {
        try
        {
            ...
            String respuesta = _serviceport.sendSummary(fleOnlyNombre.getName(),handler);

            System.out.println("fin envio.");
            System.out.println("Recibio :"+respuesta);
        ...
        catch(Exception e)
        {
            ...
            System.out.println("Error sendSummary: "+e.getMessage());
            _estado=false;
        }
        return _estado;
    }
    public boolean Enviardocumento()
    {
        ...
        {
            strError="Fallo:"+e.getMessage();
            System.out.println("Error  sendBill:"+e.getMessage());
            _estado=false;
        }
        return _estado;
    }
