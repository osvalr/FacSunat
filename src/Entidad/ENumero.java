...
public class ENumero {
    ...
    public ENumero(int num_ncodigo, String num_cserie, String num_cnumero, int suc_ncodigo, String doc_ccodigo, int par_ncodigo,String x_docuemntodescripcion,String x_sucalias,InstanciaEntidad x_instancia) {
