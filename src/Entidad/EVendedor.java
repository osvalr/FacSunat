...
public class EVendedor {
    ...
    private InstanciaEntidad m_instanciaentidad;
    private String ven_cnumero;
    public EVendedor()
    {}
    public EVendedor(int ven_ncodigo, String ven_nombres, String ven_cpaterno, String ven_materno, String doi_ccodigo, String x_numero,String doi_cdescripcion,InstanciaEntidad x_instancia) {
...
//    }
    ...
    public InstanciaEntidad getM_instanciaentidad() {
        return m_instanciaentidad;
    }

    public void setM_instanciaentidad(InstanciaEntidad m_instanciaentidad) {
