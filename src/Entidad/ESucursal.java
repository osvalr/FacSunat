...
public class ESucursal {
    ...
    public ESucursal() {
     ...
     public ESucursal(int suc_ncodigo, String suc_cdireccion, int pai_ncodigo, int emp_ncodigo, int ubi_ncodigo,String suc_cdescripcion,String x_departamento,String x_provincia,String x_distrito,String x_coddistrito,String x_coddepa,String x_codpro,String x_paisnombre,InstanciaEntidad x_instancia) {
