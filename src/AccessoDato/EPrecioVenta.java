...
public class EPrecioVenta {
    ...
    public EPrecioVenta(int pve_ncodigo, int art_ncodigo, float pve_fpreciounitario, float pve_fprecioventa, float pve_figv, String pve_ctipoprecio, InstancaEntidad m_instancia, int uni_ccodigo, String pve_cmoneda, String pve_ccodbarra, String uni_cdescripcion,int cantidadxitem,int nporcentaje,String tipoafecta,String art_cafectacion, String art_cafecdescripcion,String art_cdescripcion,String x_codigoArticulo) {
