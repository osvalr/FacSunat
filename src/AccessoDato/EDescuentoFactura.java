...
public class EDescuentoFactura {
    ...
    public EDescuentoFactura(int x_dsa_ncodigo,double x_fporcentaje,double x_limite,String x_docncodigo,int x_cdsncodigo,String x_doccdescripcion,InstancaEntidad x_instancia)
    {
